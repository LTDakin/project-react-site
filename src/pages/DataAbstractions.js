 ...
 * TAs: Josh, Tito
 * Due Date: 12/7
 * Description: The following class displays JavaScript Data Abstractions from our Language Study.
 */
...
class DataAbstractions extends React.Component{
 
  //Renders the Data Abstractions page
    render() {
        return (
        <div className="DataAbstractions">
          <header className = "DataAbstractions"></header>
          <Jumbotron>
...
export default DataAbstractions;